 ...
 *
 * 1. <B>Creating a mesh object</B>: In the first phase we create a
 *    mesh object. To this end we need to call the mesh::mesh()
 ...
 *    The constructor of mesh, also creates an empty deal.II
 ...
 *
 * 2. <B>Create a model object </B>: The constructor of the model
 ...
 *    pointer to a const mesh (this is done in the
 *    constructor of the model).
 *
 * 3. <B>Create a derived class of base_basis and pass it to model</B>:
 ...
 *    cell_manager to the cell. The cell_manager is a class that
