...
distributed_vector<dim, spacedim>::distributed_vector(
...
template <int dim, int spacedim>
void distributed_vector<dim, spacedim>::assemble(const unsigned &idx,
                                                 const double &val)
{
...
template <int dim, int spacedim>
void distributed_vector<dim, spacedim>::reinit_global_vec(
...
template <int dim, int spacedim>
void distributed_vector<dim, spacedim>::copy_to_global_vec(
...
template <int dim, int spacedim> dealiiTriCell<dim, spacedim>::dealiiTriCell()
{
}
...
template <int dim, int spacedim>
dealiiTriCell<dim, spacedim>
dealiiTriCell<dim, spacedim>::generic_neighbor(const unsigned i_face)
{
...
template <int dim, int spacedim>
bool dealiiTriCell<dim, spacedim>::generic_neighbor_is_coarser(
...
template <int dim, int spacedim>
unsigned
dealiiTriCell<dim, spacedim>::generic_neighbor_face_no(const unsigned i_face)
{
...
template <int dim, int spacedim>
dealiiTriCell<dim, spacedim>
dealiiTriCell<dim, spacedim>::generic_neighbor_child_on_subface(
