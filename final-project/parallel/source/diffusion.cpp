...
diffusion<dim, spacedim>::diffusion(dealiiTriCell<dim, spacedim> *inp_cell,
...
template <int dim, int spacedim> diffusion<dim, spacedim>::~diffusion() {}
...
void diffusion<dim, spacedim>::diffusion::init_manager(
...
template <int dim, int spacedim>
void diffusion<dim, spacedim>::assign_data(diffusion *in_cell, data *in_data)
{
...
CellManagerType *diffusion<dim, spacedim>::get_manager()
{
...
const BasisType *diffusion<dim, spacedim>::get_basis() const
{
...
template <int dim, int spacedim>
diffusion<dim, spacedim>::viz_data::viz_data(
...
template <int dim, int spacedim>
diffusion<dim, spacedim>::hdg_polybasis::hdg_polybasis(
...
template <int dim, int spacedim>
dealii::Point<dim - 1>
diffusion<dim, spacedim>::hdg_polybasis::adjusted_subface_quad_points(
...
template <int dim, int spacedim>
unsigned diffusion<dim, spacedim>::hdg_polybasis::get_n_dofs_per_face()
{
  return 1;
}
...
template <int dim, int spacedim>
std::vector<unsigned>
diffusion<dim, spacedim>::hdg_polybasis::get_n_unkns_per_dofs() const
{
...
diffusion<dim, spacedim>::hdg_polybasis::get_local_fe() const
{
  return &local_fe;
}
...
diffusion<dim, spacedim>::hdg_polybasis::get_trace_fe() const
{
  return &trace_fe;
}
...
diffusion<dim, spacedim>::hdg_polybasis::get_refn_fe() const
{
  return &refn_fe;
}
...
template <int dim, int spacedim>
const dealii::FESystem<dim> *
diffusion<dim, spacedim>::hdg_polybasis::get_viz_fe() const
{
  return &local_fe;
}
...
template <int dim, int spacedim>
unsigned diffusion<dim, spacedim>::hdg_polybasis::get_face_quad_size() const
{
...
template <int dim, int spacedim>
unsigned diffusion<dim, spacedim>::hdg_polybasis::get_cell_quad_size() const
{
...
template <int dim, int spacedim>
unsigned
diffusion<dim, spacedim>::hdg_polybasis::n_unkns_per_local_scalar_dof() const
{
...
template <int dim, int spacedim>
unsigned diffusion<dim, spacedim>::hdg_polybasis::n_trace_unkns_per_cell() const
{
...
template <int dim, int spacedim>
unsigned diffusion<dim, spacedim>::hdg_polybasis::n_trace_unkns_per_face() const
{
...
template <int dim, int spacedim>
unsigned diffusion<dim, spacedim>::hdg_polybasis::n_local_unkns_per_cell() const
{
...
template <int dim, int spacedim>
template <typename BasisType>
diffusion<dim, spacedim>::hdg_manager<BasisType>::hdg_manager(
  const diffusion<dim, spacedim> *in_cell, const BasisType *in_basis)
...
template <int dim, int spacedim>
template <typename BasisType>
void diffusion<dim, spacedim>::hdg_manager<BasisType>::assign_my_BCs(BC_Func f)
{
  f(this);
}
...
template <int dim, int spacedim>
template <typename BasisType>
void diffusion<dim, spacedim>::hdg_manager<
...
template <int dim, int spacedim>
template <typename BasisType>
void diffusion<dim, spacedim>::hdg_manager<BasisType>::assemble_my_globals(
...
template <int dim, int spacedim>
template <typename BasisType>
void diffusion<dim, spacedim>::hdg_manager<BasisType>::
...
template <int dim, int spacedim>
template <typename BasisType>
void diffusion<dim, spacedim>::hdg_manager<BasisType>::compute_my_local_unkns(
...
template <int dim, int spacedim>
template <typename BasisType>
void diffusion<dim, spacedim>::hdg_manager<BasisType>::compute_my_matrices()
{
...
template <int dim, int spacedim>
template <typename BasisType>
void diffusion<dim, spacedim>::hdg_manager<BasisType>::compute_tokamak_matrices(
  std::function<dealii::Tensor<1, dim>(const dealii::Point<spacedim> &p)>
    b_func)
{
...
template <int dim, int spacedim>
template <typename BasisType>
void diffusion<dim, spacedim>::hdg_manager<BasisType>::interpolate_to_my_trace()
{
  const diffusion *own_cell = static_cast<const diffusion *>(this->my_cell);
...
template <typename BasisType>
void diffusion<dim,
               spacedim>::hdg_manager<BasisType>::interpolate_to_my_interior()
{
  const diffusion *own_cell = static_cast<const diffusion *>(this->my_cell);
  unsigned n_scalar_unkns = my_basis->n_unkns_per_local_scalar_dof();
...
template <int dim, int spacedim>
template <typename BasisType>
void diffusion<dim, spacedim>::hdg_manager<BasisType>::fill_my_viz_vector(
...
template <int dim, int spacedim>
template <typename BasisType>
void diffusion<dim, spacedim>::hdg_manager<BasisType>::fill_my_refn_vector(
  distributed_vector<dim, spacedim> *out_vec)
{
  unsigned n_scalar_unkns = my_basis->n_unkns_per_local_scalar_dof();
  //
...
template <int dim, int spacedim>
template <typename BasisType>
void diffusion<dim, spacedim>::hdg_manager<BasisType>::set_my_source_and_BCs()
{
  const diffusion *own_cell = static_cast<const diffusion *>(this->my_cell);
  unsigned n_scalar_unkns = my_basis->n_unkns_per_local_scalar_dof();
...
template <int dim, int spacedim>
template <typename BasisType>
void diffusion<dim, spacedim>::hdg_manager<BasisType>::compute_my_errors(
...
template <int dim, int spacedim>
template <typename BasisType>
void diffusion<dim, spacedim>::hdg_manager<BasisType>::set_flux_vector(
...
template <int dim, int spacedim>
template <typename BasisType>
void diffusion<dim, spacedim>::hdg_manager<BasisType>::assign_BCs(
...
template <int dim, int spacedim>
template <typename BasisType>
void diffusion<dim, spacedim>::hdg_manager<BasisType>::interpolate_to_trace(
  diffusion *in_cell)
{
  hdg_manager *own_manager = in_cell->template get_manager<hdg_manager>();
...
template <int dim, int spacedim>
template <typename BasisType>
void diffusion<dim, spacedim>::hdg_manager<BasisType>::interpolate_to_interior(
  diffusion *in_cell)
{
  hdg_manager *own_manager = in_cell->template get_manager<hdg_manager>();
...
template <int dim, int spacedim>
template <typename BasisType>
void diffusion<dim, spacedim>::hdg_manager<BasisType>::fill_viz_vector(
...
template <int dim, int spacedim>
template <typename BasisType>
void diffusion<dim, spacedim>::hdg_manager<BasisType>::fill_refn_vector(
  diffusion *in_cell, distributed_vector<dim, spacedim> *out_vec)
{
  hdg_manager *own_manager = in_cell->template get_manager<hdg_manager>();
...
template <int dim, int spacedim>
template <typename BasisType>
void diffusion<dim, spacedim>::hdg_manager<BasisType>::set_source_and_BCs(
  diffusion *in_cell)
{
  hdg_manager *own_manager = in_cell->template get_manager<hdg_manager>();
...
void diffusion<dim, spacedim>::hdg_manager<BasisType>::apply_R_I_source(
  diffusion *in_cell)
{
  hdg_manager *own_manager = in_cell->template get_manager<hdg_manager>();
...
template <int dim, int spacedim>
template <typename BasisType>
void diffusion<dim, spacedim>::hdg_manager<BasisType>::assemble_globals(
...
template <int dim, int spacedim>
template <typename BasisType>
void diffusion<dim, spacedim>::hdg_manager<BasisType>::assemble_tokamak_globals(
  diffusion *in_cell, solvers::base_implicit_solver<dim, spacedim> *in_solver,
  std::function<dealii::Tensor<1, dim>(const dealii::Point<spacedim> &p)>
    b_func)
{
...
template <int dim, int spacedim>
template <typename BasisType>
void diffusion<dim, spacedim>::hdg_manager<BasisType>::compute_matrices(
  diffusion *in_cell)
{
  hdg_manager *own_manager =
    static_cast<hdg_manager *>(in_cell->my_manager.get());
...
template <int dim, int spacedim>
template <typename BasisType>
void diffusion<dim, spacedim>::hdg_manager<BasisType>::compute_local_unkns(
  diffusion *in_cell, const double *trace_sol)
{
  hdg_manager *own_manager =
    static_cast<hdg_manager *>(in_cell->my_manager.get());
...
template <int dim, int spacedim>
template <typename BasisType>
void diffusion<dim, spacedim>::hdg_manager<BasisType>::compute_errors(
...
template <int dim, int spacedim>
template <typename BasisType>
void diffusion<dim, spacedim>::hdg_manager<BasisType>::visualize_results(
  const viz_data &in_viz_data)
{
