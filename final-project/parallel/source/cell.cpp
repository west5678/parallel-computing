...
cell_manager<dim, spacedim>::cell_manager(const cell<dim, spacedim> *in_cell)
  : my_cell(in_cell)
{
}
...
template <int dim, int spacedim>
hybridized_cell_manager<dim, spacedim>::hybridized_cell_manager(
...
template <int dim, int spacedim>
void hybridized_cell_manager<dim, spacedim>::set_cell_properties(
...
template <int dim, int spacedim>
void hybridized_cell_manager<dim, spacedim>::set_owned_unkn_ids(
...
template <int dim, int spacedim>
void hybridized_cell_manager<dim, spacedim>::set_local_unkn_ids(
  const unsigned i_face,
  const unsigned local_num_,
  const std::vector<unsigned> &n_unkns_per_dofs)
{
...
template <int dim, int spacedim>
void hybridized_cell_manager<dim, spacedim>::set_ghost_unkn_ids(
...
template <int dim, int spacedim>
void hybridized_cell_manager<dim, spacedim>::set_nonlocal_unkn_ids(
  const unsigned i_face,
...
template <int dim, int spacedim>
void hybridized_cell_manager<dim, spacedim>::offset_global_unkn_ids(
...
template <int dim, int spacedim>
bool hybridized_cell_manager<dim, spacedim>::face_is_not_visited(
  const unsigned i_face)
{
...
template <int dim, int spacedim>
unsigned hybridized_cell_manager<dim, spacedim>::get_n_open_unkns_on_face(
...
template <int dim, int spacedim>
void hybridized_cell_manager<dim, spacedim>::assign_dof_handler_cells(
...
template <int dim, int spacedim>
void hybridized_cell_manager<dim, spacedim>::remove_from_memory()
{
}
...
void
  hybridized_cell_manager<dim, spacedim>::free_up_memory(PackType... pack_args)
{
  //
...
template <int dim, int spacedim>
cell<dim, spacedim>::cell(dealiiTriCell<dim, spacedim> *inp_cell,
...
template <int dim, int spacedim> cell<dim, spacedim>::~cell() {}
...
cell<dim, spacedim>::create(dealiiTriCell<dim, spacedim> *in_cell,
