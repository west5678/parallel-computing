#include "../include/dof_counter.hpp"

template <int dim, int spacedim> dof_counter<dim, spacedim>::dof_counter() {}
...
void dof_counter<dim, spacedim>::reset_components()
{
...
template <int dim, int spacedim>
implicit_hybridized_numbering<dim, spacedim>::implicit_hybridized_numbering()
...
void implicit_hybridized_numbering<dim, spacedim>::count_globals(
